...
import pytest
from xasset.pipeline.utils.mesh_utils import check_poly_clock, ear_cut_triangulation, build_polygon_mesh
...
from xasset.pipeline.utils.uv_utils import compute_wall_uv, map_uv_planar
...
from xasset.pipeline.stages.geometry.house.mesh_build import (
    Opening, SubMesh, WallSegmentMesh, RegionGeometry, SceneMesh,
    MeshBuildOutput, MeshBuilderService, WALL_THICKNESS_DEFAULT,
)
from xasset.pipeline.stages.understand.scene_understand import SceneRegion, DoorInfo
...
from xasset.pipeline.stages.geometry.house.mesh_build import MeshBuildStage, MeshBuildOutput
