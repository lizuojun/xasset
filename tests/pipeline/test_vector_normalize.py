...
import math
import pytest
from xasset.pipeline.utils.vector_normalize import normalize_polygon, normalize_scene_vector, NormalizeResult
...
def test_cw_polygon_converted_to_ccw():
    """顺时针输入，输出应翻转为逆时针。"""
    from xasset.pipeline.utils.mesh_utils import check_poly_clock
