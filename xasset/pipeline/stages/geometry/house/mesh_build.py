# xasset/pipeline/stages/geometry/house/mesh_build.py
...
from xasset.pipeline.stages.understand.scene_understand import (
    SceneUnderstandOutput,
    SceneRegion,
    DoorInfo,
    WindowInfo,
)
from xasset.pipeline.utils.mesh_utils import ear_cut_triangulation, check_poly_clock
from xasset.pipeline.utils.uv_utils import map_uv_planar, compute_wall_uv
